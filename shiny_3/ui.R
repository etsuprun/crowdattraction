...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    conditionalPanel(condition="input.conditionedPanels==4",
                     ...
                     dateInput("date", "Date to visit aquarium:", value="2015-08-01"),
                     helpText("Note: After select the day your are going to visit the Aquarium, a predicted crowd of that day will be ploted on the right.")
    ),
    ...
    conditionalPanel(condition="input.conditionedPanels==2",
        ...
        mainPanel(
                tabsetPanel(
                        ...
                        , 
                        tabPanel("Prediction", value=4, plotOutput("prediction")),
